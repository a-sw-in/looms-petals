...
import styles from './WhatsAppFeedback.module.css'
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>Share your feedback or complaints directly via WhatsApp</p>
        </div>

        <div className={styles.messageBox}>
          <textarea
            className={styles.messageInput}
            placeholder="Type your message here... (feedback, complaints, suggestions, etc.)"
            value={message}
